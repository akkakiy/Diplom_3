...
class TestFeedOrder:
    ...
    def test_find_number_order_in_feed_orders(self, driver, feed_order_page, user, login):
        ...
        time.sleep(1)
# не знаю, как иначе решить задачу, без слипа падает с ошибкой
# "Other element would receive the click: <div class="Modal_modal_overlay__x2ZCr"></div>"
# никто не смог помочь с решением задачи
